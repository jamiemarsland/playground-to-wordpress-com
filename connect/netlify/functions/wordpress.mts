...
function page(title, body, status = 200, extra = [], bridge = false) {
  ...
  return new Response(`<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>${escape(title)} | Playground Connect</title><style>:root{--wp-blue:#3858e9;--wp-blue-dark:#1d35b4;--ink:#101517;--muted:#50575e;--line:#dcdcde}body{font:16px/1.65 -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Inter,sans-serif;background:#f6f7f7;color:var(--ink);margin:0;padding:7vh 20px}main{max-width:620px;margin:auto;background:#fff;padding:40px;border-radius:12px;border:1px solid var(--line)}small.kick{display:block;font-size:11px;letter-spacing:.16em;font-weight:700;text-transform:uppercase;color:var(--muted)}h1{font-size:30px;line-height:1.15;font-weight:700;letter-spacing:-.02em;margin:12px 0 18px}h2{font-size:19px;font-weight:700;margin:0 0 8px}p,li{color:var(--muted)}p strong{color:var(--ink)}section{border:1px solid var(--line);border-radius:8px;padding:22px;margin:22px 0}li{padding-left:4px}strong{overflow-wrap:anywhere}a{color:var(--wp-blue)}button,.button{display:inline-block;background:var(--wp-blue);color:#fff;padding:12px 22px;border:0;border-radius:4px;font:inherit;font-weight:600;text-decoration:none;cursor:pointer}button:hover,.button:hover{background:var(--wp-blue-dark)}button:disabled{background:#dcdcde;color:#646970;cursor:not-allowed}button:disabled:hover{background:#dcdcde}code{display:block;background:#f6f7f7;border:1px solid var(--line);border-radius:4px;padding:16px;overflow-wrap:anywhere;font-size:13px}small{color:#787c82}progress{width:100%;height:6px;border-radius:999px;overflow:hidden;margin:4px 0 0}.steps{list-style:none;margin:22px 0;padding:0}.steps li{display:grid;grid-template-columns:22px 1fr auto;align-items:baseline;gap:12px;padding:9px 0;color:#8c8f94;font-size:15px}.steps .dot{position:relative;top:3px;width:14px;height:14px;border-radius:50%;border:2px solid #dcdcde;background:#fff}.steps .note{font-size:13px;color:#8c8f94;font-variant-numeric:tabular-nums}.steps li.now{color:var(--ink)}.steps li.now .dot{border-color:var(--wp-blue);box-shadow:0 0 0 4px rgba(56,88,233,.14)}.steps li.was{color:var(--muted)}.steps li.was .dot{border-color:#0f9d58;background:#0f9d58}.done{border-color:#0f9d58;background:#f2fbf5;text-align:center;padding:34px 26px}.done h2{color:#0b6b3d;font-size:23px;margin-bottom:10px}.done p{color:#33604a}.done-mark{display:inline-grid;place-items:center;width:46px;height:46px;border-radius:50%;background:#0f9d58;color:#fff;font-size:23px;line-height:1;margin-bottom:14px}.button-go{background:#0f9d58}.button-go:hover{background:#0b7f46}a:focus-visible,button:focus-visible{outline:2px solid var(--wp-blue);outline-offset:3px}</style><main><small class="kick">PUT YOUR SITE ONLINE</small><h1>${escape(title)}</h1>${body}</main>${bridge ? '<script src="/transfer.js" defer></script>' : ''}</html>`,{status,headers:h});
}
